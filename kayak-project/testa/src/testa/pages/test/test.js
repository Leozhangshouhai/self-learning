...
define('testa/pages/test/test', function (require, exports, module) {
...
var page;
  ...
  page = VuePage({
    ...
    staticRenderFns: {}, source: ['testa/pages/test/test.tpl', 'testa/pages/test/test.css'],
    el: 'testa-pages-test',
    //这里必须 使用一个方法返回给data
    data: function data() {
      return {
