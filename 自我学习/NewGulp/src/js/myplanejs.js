        ...
        success: function (data) {
            if (data.head.rtnCode == '000000') {
                ...
                if (obj.firstline.orderstatus == '5') {
                    ...
                    if(obj.firstline.ticketstatus == '1'){
                        if(obj.ordertype == '1'){
                    ...
                    }else if(obj.firstline.ticketstatus == '5'){
                        $('#firstairlinestatus').html("出票失败");
                    }else if(obj.firstline.ticketstatus == '1'){
                        $('#firstairlinestatus').html("已出票");
                    }
                }
                if (obj.secondline == null || obj.secondline.airco == null || obj.secondline.airco == '') {
                    ...
                    if (obj.secondline.orderstatus == '5') {
                        ...
                        if(obj.secondline.ticketstatus == '1'){
                            if(obj.ordertype == '1'){
                        ...
                        } else if(obj.secondline.ticketstatus == '5'){
                            $('#secondairlinestatus').html("出票失败");
                        }else if(obj.secondline.ticketstatus == '1'){
                            $('#secondairlinestatus').html("已出票");
                        }
                    }
                }
